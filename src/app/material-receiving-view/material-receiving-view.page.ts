...
@Component({
  selector: 'app-material-receiving-view',
  templateUrl: './material-receiving-view.page.html',
  styleUrls: ['./material-receiving-view.page.scss'],
})
export class MaterialReceivingViewPage implements OnInit {
