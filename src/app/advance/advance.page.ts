 ...
 onlyNumberKey(event:any) {
  ...
  async reloadDepositData(){
      ...
      //this.submitted = true;
        ...
        this.http.post(host+'user-advance-request-get', JSON.stringify(data),{ headers: headers })
        .subscribe((res:any) => {
         //console.log(res);
         loading.dismiss();
        if(res.status == true){
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.http.post(host+'user-advance-request-deletebyid', JSON.stringify(localarray),{ headers: headers })
            .subscribe((res:any) => {
             // console.log(res);
             loading.dismiss();
            if(res.status == true){
