...
@Component({
  ...
  templateUrl: './material-issue-add.page.html',
  styleUrls: ['./material-issue-add.page.scss'],
})
export class MaterialIssueAddPage implements OnInit {
 ...
 async reloadDepositData(){
      ...
      //this.submitted = true;
        ...
        this.http.post(host+'get-material-issue-request-list-add', JSON.stringify(data),{ headers: headers })
        .subscribe((res:any) => {
         //console.log(res);
         loading.dismiss();
        if(res.status == true){
...
//console.log(data);
        ...
        this.http.post(host+'get-material-issue-request-list-create', JSON.stringify(data),{ headers: headers })
        .subscribe((res:any) => {
        //console.log(res);
         loading.dismiss();
        if(res.status == true){
